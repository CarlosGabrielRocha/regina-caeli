...
export default function Footer() {
  return (
    <footer id="contact" className="bg-primary mt-auto">
      <div className="h-10 3xl:h-13 w-full bg-secondary border-b border-white/70" />
      <ContainerLimit size="smaller">
        <div className="flex flex-col gap-10 3xl:gap-13 px-10 pt-8 3xl:pt-11">
          ...
          <div className="border-t border-white/70 py-4">
            <a
              href="https://carlosgabrieldev.vercel.app"
              target="_blank"
              className="flex space-x-2 justify-end items-center"
            >
              <p className="zcool text-xl md:text-2xl 3xl:text-3xl">CG</p>
