...
export function PropertiesContainer({ children }: { children: ReactNode }) {
  return (
    <div className="grid grid-cols-[repeat(auto-fill,minmax(13rem,17rem))] sm:grid-cols-[repeat(auto-fit,minmax(14rem,17rem))] lg:grid-cols-[repeat(4,minmax(14rem,17rem))] 2xl:grid-cols-[repeat(4,minmax(18rem,22rem))] gap-3 md:gap-6 w-full py-5 md:py-10 justify-center items-center">
      {children}
    </div>
  );
}
