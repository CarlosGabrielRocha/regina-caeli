...
export default function PropertyPagination({
  ...
  const handlePageChange = (newPage: number) => {
    ...
    // Ensure we keep existing params and only update 'page'
    // This supports both "User Search" (where other params exist)
    // and "Similar Properties" (where we might only have page, or nothing)
