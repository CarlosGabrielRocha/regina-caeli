...
export function FilterTag({
  ...
  return (
    <div className="group relative flex flex-col justify-end max-w-30 md:max-w-70 mb-3 cursor-pointer shadow-md">
      ...
      <button>
        <Text
          size="small"
          type="span"
          className="bg-highlight/30 border rounded-sm px-2 py-1 max-w-40 truncate block text-start"
        >
